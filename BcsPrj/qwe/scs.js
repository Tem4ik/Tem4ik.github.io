...
(function($){let pluginsID=[];let Plugin=function(elem,options){this.elem=elem;this.$elem=$(elem);this.options=$.extend({padding:'0px',closeBtnInside:true,openSelector:null,speedShowClose:500,},options);this.stateEl=null;};const template={Popup:'<div class="Popup"></div>',PopupWrap:'<div class="Popup-Wrap"></div>',PopupClose:'<div class="Popup__Close"><svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 17.71L9 9.70996M17 1.70996L9 9.70996M9 9.70996L17 17.71M9 9.70996L1 1.70996" stroke="#0F0F0F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>',PopupContent:'<div class="Popup-Content"></div>',}
Plugin.prototype={init:function(){this.$elem.wrap(template.Popup);this.$elem.wrap(template.PopupWrap);this.$elem.wrap(template.PopupContent);this.$elem.closest('.Popup-Wrap').prepend(template.PopupClose);this.stateEl={Popup:this.$elem.closest('.Popup'),PopupContent:this.$elem.closest('.Popup-Content'),PopupClose:this.$elem.closest('.Popup-Wrap').find('.Popup__Close'),}
this.stateEl.Popup.css({transition:this.options.speedShowClose+'ms'})
this.stateEl.PopupContent.css({padding:this.options.padding,})
if(!this.options.closeBtnInside){this.stateEl.PopupClose.addClass('Popup__Close_outside');}
let _this=this;this.stateEl.Popup.on('click',function(){_this.hide();})
this.stateEl.PopupContent.on('click',function(e){e.stopPropagation();})
this.stateEl.PopupClose.on('click',function(){_this.hide();});if(this.options.openSelector!=null){this.options.openSelector.forEach(function(item){$(document).on('click',item,function(){_this.show();})});}
return this;},show:function(){compensateBody();this.stateEl.Popup.addClass('Popup_open');},hide:function(){this.stateEl.Popup.removeClass('Popup_open');setTimeout(function(){unCompensateBody();},this.options.speedShowClose)},}
Plugin.show=Plugin.prototype.show;Plugin.hide=Plugin.prototype.hide;$.fn.showPopup=function(options){if(typeof options==='object'||!options){let newPlugin=new Plugin(this,options).init();$(this[0]).attr('data-class',pluginsID.length)
pluginsID.push(newPlugin);}else if(Plugin.prototype[options]){pluginsID[$(this[0]).attr('data-class')][options]();}else{$.error('Метод с именем '+options+' не существует для jQuery.tooltip');}}})(jQuery);
/*!
...
function checkPhone(){if($(this).attr('data-required')!==undefined){if(!$(this).inputmask("isComplete")){$(this).removeClass('input-border');$(this).addClass('input-err');}else{$(this).removeClass('input-err');$(this).addClass('input-border');}}else if($(this).val()===''){$(this).removeClass('input-border');}else{$(this).addClass('input-border');}}
const emailPattern=/^[a-z0-9_-]+@[a-z0-9-]+\.([a-z]{1,6}\.)?[a-z]{2,6}$/i;function checkEmail(){if($(this).attr('data-required')!==undefined){if($(this).val().search(emailPattern)!==0){$(this).removeClass('input-border');$(this).addClass('input-err');}else{$(this).removeClass('input-err');$(this).addClass('input-border');}}else if($(this).val()===''){$(this).removeClass('input-border');}else{$(this).addClass('input-border');}}
function checkText(){if($(this).attr('data-required')!==undefined){if($(this).val()===''){$(this).removeClass('input-border');$(this).addClass('input-err');}else{$(this).removeClass('input-err');$(this).addClass('input-border');}}else if($(this).val()===''){$(this).removeClass('input-border');}else{$(this).addClass('input-border');}}
function checkCheckbox(){if($(this).prop('checked')!==true){$(this).removeClass('input-border');$(this).addClass('input-err');}else{$(this).removeClass('input-err');$(this).addClass('input-border');}}
function checkForm(form){let phones=form.find('input[data-type="tel"]');let emails=form.find('input[data-type="email"]');let texts=form.find('input:not([data-type="email"]):not([data-type="tel"])');let checks=form.find('input[type="checkbox"][data-required]');phones.each(function(){checkPhone.apply(this);})
emails.each(function(){checkEmail.apply(this);})
texts.each(function(){checkText.apply(this);})
checks.each(function(){checkCheckbox.apply(this);})}
function Validation(form){let valid=true;form.find('input[data-required]').each(function(el,i){if(!$(this).hasClass('input-border')){valid=false;}})
return valid;}
function cleanForm(form){form.find('.input-err, .input-border').each(function(){$(this).removeClass('input-err').removeClass('input-border').val('')})}
function submitForm(elem,event){event.preventDefault();let form=$(elem).closest('form');checkForm(form);if(Validation(form)){var SuccessForm__Img=bodymovin.loadAnimation({container:document.getElementById('SuccessForm__Img'),renderer:'svg',loop:false,autoplay:false,path:'http://beav1s.beget.tech/assets/templates/aCount/assets/lottie/Success.json'})
if(form.hasClass('FormPopup')){$('.FormPopup').showPopup('hide');setTimeout(function(){$('.SuccessForm').showPopup('show');setTimeout(function(){SuccessForm__Img.play();},500)
setTimeout(function(){$('.SuccessForm').showPopup('hide');setTimeout(function(){SuccessForm__Img.destroy();},500);},2000)},500)}else{$('.SuccessForm').showPopup('show');setTimeout(function(){SuccessForm__Img.play();},500)
setTimeout(function(){$('.SuccessForm').showPopup('hide');setTimeout(function(){SuccessForm__Img.destroy();},500);},2000)}
form.submit();cleanForm(form);}}
$(document).ready(function(){$(document).find('[data-type="tel"]').inputmask({mask:"+7 (999) 999-99-99",showMaskOnHover:false,showMaskOnFocus:true});$(document).on('blur','input[data-type="tel"]',function(){checkPhone.apply(this);})
$(document).on('blur','input[data-type="email"]',function(){checkEmail.apply(this);})
$(document).on('blur','input:not([data-type="email"]):not([data-type="tel"])',function(){checkText.apply(this);})
$(document).on('change','input[type="checkbox"][data-required]',function(){checkCheckbox.apply(this);})})
function getScrollBarWidth(){var inner=document.createElement('p');inner.style.width="100%";inner.style.height="200px";var outer=document.createElement('div');outer.style.position="absolute";outer.style.top="0px";outer.style.left="0px";outer.style.visibility="hidden";outer.style.width="200px";outer.style.height="150px";outer.style.overflow="hidden";outer.appendChild(inner);document.body.appendChild(outer);var w1=inner.offsetWidth;outer.style.overflow='scroll';var w2=inner.offsetWidth;if(w1==w2)w2=outer.clientWidth;document.body.removeChild(outer);return(w1-w2);};function compensateBody(){$('body').addClass('BodyOverflow');$('body').css('padding-right',getScrollBarWidth());}
function unCompensateBody(){$('body').attr('style','');$('body').removeClass('BodyOverflow');}
function waitforCSSisApplied(){if(!document.body){return new Promise((res,rej)=>{window.addEventListener('DOMContentLoaded',e=>{waitforCSSisApplied().then(res);});});}
const waiter=document.createElement('style');waiter.innerHTML='body{opacity:.99;}';return new Promise((res,rej)=>{function done(evt){waiter.parentNode&&waiter.parentNode.removeChild(waiter);trigger.parentNode&&trigger.parentNode.removeChild(trigger);res();}
function trigger(){const trigger=document.createElement('style');trigger.innerHTML='body{opacity:1;  transition: opacity 0.1s linear;}';document.body.offsetWidth;document.head.appendChild(trigger);}
document.head.appendChild(waiter);document.body.addEventListener('transitionend',done,{once:true})
if(document.readyState!=='complete'){window.addEventListener('load',trigger);}
else{setTimeout(trigger,0);}});}
function setCityWidth(){$('.HeaderInfo-City').width($('.HeaderInfo-City__El_active').width());}
function sortAndMoveCities(){let notActiveCities=$('.HeaderInfo-City__El:not(.HeaderInfo-City__El_active)');for(let i=0;i<notActiveCities.length;i++){let top=(24+8)*(i+1);$(notActiveCities[i]).css('top',top+'px');}}
function setBgGabarites(){let cities=$('.HeaderInfo-City__El');let width=0;let height=40;for(let i=0;i<cities.length;i++){if($(cities[i]).width()>width){width=$(cities[i]).width();}
height+=32;}
height-=32;width+=24;$('.HeaderInfo-City__Bg').width(width);$('.HeaderInfo-City__Bg').height(height);}
function setNewCity(_this){$('.HeaderInfo-City__El_active').removeClass('HeaderInfo-City__El_active');_this.addClass('HeaderInfo-City__El_active');$('.HeaderInfo__Phone_active').removeClass('HeaderInfo__Phone_active');$(`.HeaderInfo__Phone[data-phonenum="${_this.attr('data-phonenum')}"]`).addClass('HeaderInfo__Phone_active');setBgGabarites();sortAndMoveCities();setCityWidth();}
$(document).ready(function(){sortAndMoveCities();waitforCSSisApplied().then(()=>{setTimeout(function(){setCityWidth();},200);setBgGabarites();})
$(document).on('click','.HeaderInfo-City__El:not(.HeaderInfo-City__El_active)',function(){setNewCity($(this))})});function showMobMenu(){compensateBody();$('.Burger').addClass('Burger_active');$('.mobileMenu').addClass('mobileMenu_active');}
function hideMobMenu(){$('.mobileMenu').removeClass('mobileMenu_active');$('.Burger').removeClass('Burger_active');setTimeout(function(){unCompensateBody();},300)}
$(document).ready(function(){$(document).on('click','.Burger',function(){if(!$(this).hasClass('Burger_active')){showMobMenu();}else{hideMobMenu();}})
$(document).on('click','.mobileMenu',function(){hideMobMenu();})
$(document).on('click','.mobileMenu-Wrap',function(e){e.stopPropagation();})})
...
$(document).ready(function(){$(".aBanner-Desc__More").click(function(){var _href=$(this).attr("href");$("html, body").animate({scrollTop:($(_href).offset().top-100)+"px"});return false;});let vh=window.innerHeight*0.01;document.documentElement.style.setProperty('--vh',`${vh}px`);window.addEventListener('resize',()=>{let vh=window.innerHeight*0.01;document.documentElement.style.setProperty('--vh',`${vh}px`);});$('.ServicesItem:first-child').addClass('ServicesItem_active');$('.ServicesItem:first-child .ServicesItem-Body').slideDown(300);$(document).on('click','.ServicesItem:not(.ServicesItem_active)',function(){let _this=$(this);$('.ServicesItem_active .ServicesItem-Body').slideUp(300,function(){$('.ServicesItem_active').removeClass('ServicesItem_active');_this.addClass('ServicesItem_active');_this.find('.ServicesItem-Body').slideDown(300);});})
$('.Whom-List__Item').each(function(){$(this).height($(this).find('p:nth-child(2)').height());})
function UpdateHeightWhomListItems(){if($('.Whom-List_second').length){$('.Whom-List__Item').each(function(){console.log($(this).find('p:nth-child(1)'));$(this).height($(this).find('p:nth-child(1)').height());})}else{$('.Whom-List__Item').each(function(){$(this).height($(this).find('p:nth-child(2)').height());})}}
$(document).on('click','.Whom-List-Switch__Btn:not(.Whom-List-Switch__Btn_active)',function(){$('.Whom-List-Switch__Btn_active').removeClass('Whom-List-Switch__Btn_active');$(this).addClass('Whom-List-Switch__Btn_active');$('.Whom-List').toggleClass('Whom-List_second');UpdateHeightWhomListItems();})
$(window).on('resize',function(){UpdateHeightWhomListItems();})
$('.Cases-Slider').slick({infinite:false,slidesToShow:3,slidesToScroll:1,nextArrow:$('.Cases-Arrows__Btn_next'),prevArrow:$('.Cases-Arrows__Btn_prev'),responsive:[{breakpoint:1024,settings:{slidesToShow:2,}},{breakpoint:768,settings:{slidesToShow:1,variableWidth:true}},]})
if($('#ContactsMap').length){$('#ContactsMap').css('left',($('.Contacts-Info').width()+$('.Contacts-Info').offset().left+24)+'px');$('#ContactsMap').width(document.body.clientWidth-($('.Contacts-Info').width()+$('.Contacts-Info').offset().left+24));mapboxgl.accessToken='pk.eyJ1IjoicnliYWtvb292IiwiYSI6ImNrYXdkN3BsYTE5a2UycXB0YWN5dGkwN3YifQ.OH8c2DpPOXHUSei8v0PXqA';var map=new mapboxgl.Map({container:'ContactsMap',style:'mapbox://styles/mapbox/light-v9',center:[37.642617,55.847609],zoom:12});let Moscow=new mapboxgl.Marker().setLngLat([37.642617,55.847609]).addTo(map);let Krym=new mapboxgl.Marker().setLngLat([34.113873,44.960612]).addTo(map);var language=new MapboxLanguage({defaultLanguage:'ru'});map.addControl(language);$(window).on('resize',function(){$('#ContactsMap').css('left',($('.Contacts-Info').width()+$('.Contacts-Info').offset().left+24)+'px');$('#ContactsMap').width(document.body.clientWidth-($('.Contacts-Info').width()+$('.Contacts-Info').offset().left+24));})
$(document).on('click','.Contacts-Info-Tabs__Tab:not(.Contacts-Info-Tabs__Tab_active)',function(){let index=$(this).index();if(index==1){map.jumpTo({center:[34.113873,44.960612]});}else{map.jumpTo({center:[37.642617,55.847609]});}
$('.Contacts-Info-Tabs__Tab_active').removeClass('Contacts-Info-Tabs__Tab_active');$(this).addClass('Contacts-Info-Tabs__Tab_active');let block=$('.Contacts-Info-Body-Block:not(.Contacts-Info-Body-Block_active)');$('.Contacts-Info-Body-Block_active').removeClass('Contacts-Info-Body-Block_active')
block.addClass('Contacts-Info-Body-Block_active');})}
$(document).on('click','.Blog-Head-Filter__More',function(e){e.preventDefault();$(this).toggleClass('Blog-Head-Filter__More_active');console.log($('.Blog-Head-Filter-Item:nth-last-child(2)'));let flag=$('.Blog-Head-Filter-Item:nth-last-child(2)').is(':visible');if(flag){for(let i=0;i<=$('.Blog-Head-Filter-Item').length-8;i++){setTimeout(function(){$(`.Blog-Head-Filter-Item:nth-child(${$('.Blog-Head-Filter-Item').length-i})`).toggle(300);},i*300);}}else{for(let i=0;i<=$('.Blog-Head-Filter-Item').length-8;i++){setTimeout(function(){$(`.Blog-Head-Filter-Item:nth-child(${8+i})`).toggle(300);},i*300);}}})
if($('.Post').length){$('.PostArticle-Block-Content img').wrap('<div class="PostArticle-Block-Content-Img"></div>');}
$('.FormPopup').showPopup({openSelector:['[data-callOrder]'],});$('.SuccessForm').showPopup();$('.PopupVideo').showPopup({openSelector:['[data-video]'],closeBtnInside:false,})
const videoCoef=$('.PopupVideo').attr('height')/ $('.PopupVideo').attr('width');$('.PopupVideo').height($('.PopupVideo').width()*videoCoef)
$(window).resize(function(){$('.PopupVideo').height($('.PopupVideo').width()*videoCoef)
hideMobMenu();})
var banner=bodymovin.loadAnimation({container:document.getElementById('banner'),renderer:'svg',loop:true,autoplay:true,path:'https://a-count.net/assets/templates/aCount/assets/lottie/hands.json'})
var girl=bodymovin.loadAnimation({container:document.getElementById('girl'),renderer:'svg',loop:true,autoplay:true,path:'https://a-count.net/assets/templates/aCount/assets/lottie/girl.json'})
var people=bodymovin.loadAnimation({container:document.getElementById('people'),renderer:'svg',loop:true,autoplay:true,path:'https://a-count.net/assets/templates/aCount/assets/lottie/People.json'})
var form=bodymovin.loadAnimation({container:document.getElementById('form-anim'),renderer:'svg',loop:true,autoplay:true,path:'https://a-count.net/assets/templates/aCount/assets/lottie/Messages.json'})
var aBanner=bodymovin.loadAnimation({container:document.getElementById('aBanner'),renderer:'svg',loop:true,autoplay:true,path:'https://a-count.net/assets/templates/aCount/assets/lottie/Graphs.json'})
var Manager__Img=bodymovin.loadAnimation({container:document.getElementById('Manager__Img'),renderer:'svg',loop:true,autoplay:true,path:'https://a-count.net/assets/templates/aCount/assets/lottie/Stats.json'})
var Doubts__Img=bodymovin.loadAnimation({container:document.getElementById('Doubts__Img'),renderer:'svg',loop:true,autoplay:true,path:'https://a-count.net/assets/templates/aCount/assets/lottie/Discustion.json'})
var BlogBanner__Img=bodymovin.loadAnimation({container:document.getElementById('BlogBanner__Img'),renderer:'svg',loop:true,autoplay:true,path:'https://a-count.net/assets/templates/aCount/assets/lottie/Notebook.json'})
var kitten=bodymovin.loadAnimation({container:document.getElementById('kitten'),renderer:'svg',loop:true,autoplay:true,path:'https://a-count.net/assets/templates/aCount/assets/lottie/Kitten.json'})});
$(document).ready(function(){$(document).on('change','[name="blogFilter"]',function(){const val=$(this).val();const mutatedContainer=$('[data-entity="container-blog"]');if(val){let url=window.location.pathname+'?tag='+val;$.ajax({url:url,method:'get',dataType:'html',success:function(data){const resContainer=$(data).find('[data-entity="container-blog"]');console.log(resContainer)
mutatedContainer.html(resContainer.html());}});}})
$(document).on('click','[data-entity="show-more"]',function(){let url=$(this).data('url'),_this=this,mutatedContainer=$('[data-entity="container-blog"]');$.ajax({url:url,method:'get',dataType:'html',success:function(data){_this.remove();mutatedContainer.append($(data).find('[data-entity="container-blog"]').html());}});});})