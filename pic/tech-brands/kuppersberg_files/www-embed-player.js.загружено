...
function Da(a){return Object.prototype.hasOwnProperty.call(a,Ea)&&a[Ea]||(a[Ea]=++Ga)}
var Ea="closure_uid_"+(1E9*Math.random()>>>0),Ga=0;function Ha(a,b,c){return a.call.apply(a.bind,arguments)}
...
function dc(a,b,c){var d=arguments,e=document,f=String(d[0]),g=d[1];if(!Yb&&g&&(g.name||g.type)){f=["<",f];g.name&&f.push(' name="',Mb(g.name),'"');if(g.type){f.push(' type="',Mb(g.type),'"');var h={};pb(h,g);delete h.type;g=h}f.push(">");f=f.join("")}f=ec(e,f);g&&("string"===typeof g?f.className=g:Array.isArray(g)?f.className=g.join(" "):bc(f,g));2<d.length&&fc(e,f,d);return f}
...
function b(p){for(var v=g,u=0;64>u;u+=4)v[u/4]=p[u]<<24|p[u+1]<<16|p[u+2]<<8|p[u+3];for(u=16;80>u;u++)p=v[u-3]^v[u-8]^v[u-14]^v[u-16],v[u]=(p<<1|p>>>31)&4294967295;p=e[0];var E=e[1],U=e[2],ka=e[3],Fc=e[4];for(u=0;80>u;u++){if(40>u)if(20>u){var Fa=ka^E&(U^ka);var Fb=1518500249}else Fa=E^U^ka,Fb=1859775393;else 60>u?(Fa=E&U|ka&(E|U),Fb=2400959708):(Fa=E^U^ka,Fb=3395469782);Fa=((p<<5|p>>>27)&4294967295)+Fa+Fc+Fb+v[u]&4294967295;Fc=ka;ka=U;U=(E<<30|E>>>2)&4294967295;E=p;p=Fa}e[0]=e[0]+p&4294967295;e[1]=
e[1]+E&4294967295;e[2]=e[2]+U&4294967295;e[3]=e[3]+ka&4294967295;e[4]=e[4]+Fc&4294967295}
...
function Dc(a){-1==a.f&&(a.f=Oa(a.g,function(b,c,d){return c?b+Math.pow(2,d):b},0));
return a.f}
;function Ec(a,b){this.h=a;this.i=b;this.g=0;this.f=null}
Ec.prototype.get=function(){if(0<this.g){this.g--;var a=this.f;this.f=a.next;a.next=null}else a=this.h();return a};
...
var Mc=new Ec(function(){return new Lc},function(a){a.reset()});
...
var ud=new Ec(function(){return new td},function(a){a.reset()});
...
w.document.createElementNS&&l.set(0);c=uc();c["allow-top-navigation-by-user-activation"]&&l.set(1);c["allow-popups-to-escape-sandbox"]&&l.set(2);w.crypto&&w.crypto.subtle&&l.set(3);w.TextDecoder&&w.TextEncoder&&l.set(4);l=Dc(l);n.bc=l;n.bih=k.height;n.biw=k.width;n.brdim=b.join();a=a.g;return n.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,n.wgl=!!I.WebGLRenderingContext,n}
...
If.prototype.initialize=function(a,b,c,d,e){var f=this;b?(this.g=!0,tf(b,function(){f.g=!1;window.botguard?Jf(f,c,d):(yf(b),Ye(new Ue("Unable to load Botguard","from "+b)))},e)):a&&(eval(a),window.botguard?Jf(this,c,d):Ye(Error("Unable to load Botguard from JS")))};
function Jf(a,b,c){try{a.f=new window.botguard.bg(b)}catch(d){Ye(d)}c&&c(b)}
...
function Zg(a){a=void 0===a?0:a;var b=P(Ug(a));if(!b&&!P("USE_CSN_FALLBACK",!0))return null;b||0!=a||(Q("kevlar_client_side_screens")||Q("c3_client_side_screens")?b="UNDEFINED_CSN":b=P("EVENT_ID"));return b?b:null}
...
;var Uh=window;function Vh(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var X=Uh.performance||Uh.mozPerformance||Uh.msPerformance||Uh.webkitPerformance||new Vh;function Wh(a,b){dh.call(this,1,arguments)}
r(Wh,dh);function Xh(a,b){dh.call(this,1,arguments)}
r(Xh,dh);var Yh=new eh("aft-recorded",Wh),Zh=new eh("timing-sent",Xh);var $h=!1;function ai(){var a=bi(void 0);if(a.aft)return a.aft;for(var b=P("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function ci(a){var b;(b=y("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ka("ytcsi."+(a||"")+"data_",b));return b}
function di(a){a=ci(a);a.info||(a.info={});return a.info}
function bi(a){a=ci(a);a.tick||(a.tick={});return a.tick}
function ei(a){var b=ci(a).nonce;b||(b=Pg(),ci(a).nonce=b);return b}
function fi(){var a=bi(""),b=ai();b&&!$h&&(jh(Yh,new Wh(Math.round(b-a._start),void 0)),$h=!0)}
;function gi(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!hi(a)||c.some(function(e){return!hi(e)}))throw Error("Only objects may be merged.");
c=q(c);for(d=c.next();!d.done;d=c.next())ii(a,d.value);return a}
function ii(a,b){for(var c in b)if(hi(b[c])){if(c in a&&!hi(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});ii(a[c],b[c])}else if(ji(b[c])){if(c in a&&!ji(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);ki(a[c],b[c])}else a[c]=b[c];return a}
function ki(a,b){for(var c=q(b),d=c.next();!d.done;d=c.next())d=d.value,hi(d)?a.push(ii({},d)):ji(d)?a.push(ki([],d)):a.push(d);return a}
function hi(a){return"object"===typeof a&&!Array.isArray(a)}
function ji(a){return"object"===typeof a&&Array.isArray(a)}
;function li(){var a=y("ytcsi.debug");a||(a=[],x("ytcsi.debug",a,void 0),x("ytcsi.reference",{},void 0));return a}
function mi(a){a=a||"";var b=y("ytcsi.reference");b||(li(),b=y("ytcsi.reference"));if(b[a])return b[a];var c=li(),d={timerName:a,info:{},tick:{}};c.push(d);return b[a]=d}
;function ni(a,b,c){c=void 0===c?{}:c;var d=Ng;P("ytLoggingEventsDefaultDisabled",!1)&&Ng==Ng&&(d=null);Dg(a,b,d,c)}
;var oi=y("ytLoggingLatencyUsageStats_")||{};x("ytLoggingLatencyUsageStats_",oi,void 0);function pi(){this.f=0}
function qi(){pi.f||(pi.f=new pi);return pi.f}
pi.prototype.tick=function(a,b,c){ri(this,"tick_"+a+"_"+b)||ni("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
pi.prototype.info=function(a,b){var c=Object.keys(a).join("");ri(this,"info_"+c+"_"+b)||(a.clientActionNonce=b,ni("latencyActionInfo",a))};
function ri(a,b){oi[b]=oi[b]||{count:0};var c=oi[b];c.count++;c.time=T();a.f||(a.f=Cf(function(){var d=T(),e;for(e in oi)oi[e]&&6E4<d-oi[e].time&&delete oi[e];a&&(a.f=0)},0,5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new Ue("CSI data exceeded logging limit with key",b),0===b.indexOf("info")?Ye(c):Xe(c)),!0):!1}
;var Y={},si=(Y.ad_allowed="adTypesAllowed",Y.yt_abt="adBreakType",Y.ad_cpn="adClientPlaybackNonce",Y.ad_docid="adVideoId",Y.yt_ad_an="adNetworks",Y.ad_at="adType",Y.browse_id="browseId",Y.p="httpProtocol",Y.t="transportProtocol",Y.cpn="clientPlaybackNonce",Y.cseg="creatorInfo.creatorSegment",Y.csn="clientScreenNonce",Y.docid="videoId",Y.GetHome_rid="getHomeRequestId",Y.GetSearch_rid="getSearchRequestId",Y.GetPlayer_rid="getPlayerRequestId",Y.GetWatchNext_rid="getWatchNextRequestId",Y.GetBrowse_rid=
...
"musicInfo.getMusicSearchSuggestionsRequestId",Y),ti="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),ui={},vi=(ui.mver="MEASUREMENT_VERSION_",ui.pis="PLAYER_INITIALIZED_STATE_",ui.yt_pt="LATENCY_PLAYER_",ui.pa="LATENCY_ACTION_",ui.yt_vst="VIDEO_STREAM_TYPE_",ui),wi=
"all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");function xi(a){return!!P("FORCE_CSI_ON_GEL",!1)||Q("csi_on_gel")||!!ci(a).useGel}
function yi(a){a=ci(a);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function zi(a,b,c){if(null!==b)if(di(c)[a]=b,xi(c)){var d=yi(c);if(d.gelInfos)d.gelInfos["info_"+a]=!0;else{var e={};d.gelInfos=(e["info_"+a]=!0,e)}if(a in si){d=si[a];0<=La(ti,d)&&(b=!!b);a in vi&&"string"===typeof b&&(b=vi[a]+b.toUpperCase());a=d.split(".");e=d={};for(var f=0;f<a.length-1;f++){var g=a[f];e[g]={};e=e[g]}e[a[a.length-1]]=b;b=gi({},d)}else 0<=La(wi,a)||Ye(new Ue("Unknown label logged with GEL CSI",a)),b=void 0;b&&xi(c)&&(a=mi(c||""),gi(a.info,b),a=yi(c),"gelInfos"in a||(a.gelInfos=
{}),gi(a.gelInfos,b),c=ei(c),qi().info(b,c))}else mi(c||"").info[a]=b}
if(Q("overwrite_polyfill_on_logging_lib_loaded")){var Ai=window;Ai.ytcsi&&(Ai.ytcsi.info=zi)};B(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||ya,X);function Bi(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function Ci(a,b,c){"string"===typeof a&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Di(a)}
function Di(a,b,c){if(A(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Ei(a,b,c,d){if(A(a)&&!Ba(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function Fi(a){a=void 0===a?!1:a;L.call(this);this.f=new N(a);Wc(this,Ja(Xc,this.f))}
D(Fi,L);Fi.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
Fi.prototype.j=function(a,b){this.g||this.f.M.apply(this.f,arguments)};function Gi(a,b,c){Fi.call(this);this.h=a;this.i=b;this.l=c}
r(Gi,Fi);function Hi(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(ld(a),d.i))}}
Gi.prototype.o=function(){this.i=this.h=null;Fi.prototype.o.call(this)};function Ii(a){L.call(this);this.f=a;this.f.subscribe("command",this.ra,this);this.h={};this.j=!1}
r(Ii,L);m=Ii.prototype;m.start=function(){this.j||this.g||(this.j=!0,Hi(this.f,"RECEIVING"))};
m.ra=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.h||(c=B(this.Ra,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&Ji(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=Ki(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=Li(a,c))&&this.j&&!this.g&&Hi(this.f,a,c))}}};
m.Ra=function(a,b){this.j&&!this.g&&Hi(this.f,a,this.ea(a,b))};
m.ea=function(a,b){if(null!=b)return{value:b}};
function Ji(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
m.o=function(){var a=this.f;a.g||Jd(a.f,"command",this.ra,this);this.f=null;for(var b in this.h)Ji(this,b);L.prototype.o.call(this)};function Mi(a,b){Ii.call(this,b);this.i=a;this.start()}
r(Mi,Ii);Mi.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
Mi.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function Ki(a,b){switch(a){case "loadVideoById":return b=Di(b),[b];case "cueVideoById":return b=Di(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=Ei(b),[b];case "cuePlaylist":return b=Ei(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
Mi.prototype.ea=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Ii.prototype.ea.call(this,a,b)};
Mi.prototype.o=function(){Ii.prototype.o.call(this);delete this.i};function Ni(a,b,c){L.call(this);var d=this;c=c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.w="*";this.i=c;this.sessionId=null;this.channel="widget";this.A=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.A&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
r(Ni,L);Ni.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.w)}catch(e){ke(e)}}};
Ni.prototype.o=function(){window.removeEventListener("message",this.m);L.prototype.o.call(this)};function Oi(){var a=this.g=new Ni(!!P("WIDGET_ID_ENFORCE")),b=B(this.Oa,this);a.j=b;a.l=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
m=Oi.prototype;m.Oa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,Pi(this,a)),this.j[a]=!0)):this.ma(a,b,c)};
m.ma=function(){};
function Pi(a,b){return B(function(c){this.sendMessage(b,c)},a)}
...
function Qi(a,b){a.sendMessage("infoDelivery",b)}
m.sa=function(a){this.l?this.g.sendMessage(a):this.i.push(a)};
m.sendMessage=function(a,b){this.sa({event:a,info:void 0==b?null:b})};
m.dispose=function(){this.g=null};function Ri(a){Oi.call(this);this.f=a;this.h=[];this.addEventListener("onReady",B(this.La,this));this.addEventListener("onVideoProgress",B(this.Va,this));this.addEventListener("onVolumeChange",B(this.Wa,this));this.addEventListener("onApiChange",B(this.Qa,this));this.addEventListener("onPlaybackQualityChange",B(this.Sa,this));this.addEventListener("onPlaybackRateChange",B(this.Ta,this));this.addEventListener("onStateChange",B(this.Ua,this));this.addEventListener("onWebglSettingsChanged",B(this.Xa,
this))}
r(Ri,Oi);m=Ri.prototype;m.ma=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Bi(a)){var d=b;if(A(d[0])&&!Ba(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Di.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Ci.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Ei.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Bi(a)&&Qi(this,this.fa())}};
...
this.f.getVideoUrl());this.f.getVideoContentRect&&(a.videoContentRect=this.f.getVideoContentRect());this.f.getProgressState&&(a.progressState=this.f.getProgressState());this.f.getPlaylist&&(a.playlist=this.f.getPlaylist());this.f.getPlaylistIndex&&(a.playlistIndex=this.f.getPlaylistIndex());this.f.getStoryboardFormat&&(a.storyboardFormat=this.f.getStoryboardFormat());Qi(this,a)};
m.Sa=function(a){Qi(this,{playbackQuality:a})};
m.Ta=function(a){Qi(this,{playbackRate:a})};
...
m.Wa=function(){Qi(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
m.Va=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:C()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());Qi(this,a)};
m.Xa=function(){var a={sphericalProperties:this.f.getSphericalProperties()};Qi(this,a)};
m.dispose=function(){Oi.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Si(a,b,c){L.call(this);this.f=a;this.i=c;this.j=V(window,"message",B(this.l,this));this.h=new Gi(this,a,b);Wc(this,Ja(Xc,this.h))}
r(Si,L);Si.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
Si.prototype.o=function(){$f(this.j);this.f=null;L.prototype.o.call(this)};function Ti(){var a=mb(Ui),b;return yd(new M(function(c,d){a.onSuccess=function(e){ye(e)?c(e):d(new Vi("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new Vi("Unknown request error","net.unknown",e))};
a.O=function(e){d(new Vi("Request timed out","net.timeout",e))};
...
;function Zi(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof $i;this.isTimeout=a instanceof Vi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof zd}
r(Zi,F);Zi.prototype.name="BiscottiError";function $i(){F.call(this,"Biscotti ID is missing from server")}
r($i,F);$i.prototype.name="BiscottiMissingError";var Ui={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},aj=null;function ee(){if("1"===gb(ce(),"args","privembed"))return wd(Error("Biscotti ID is not available in private embed mode"));aj||(aj=yd(Ti().then(bj),function(a){return cj(2,a)}));
return aj}
function bj(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new $i;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new $i;a=a.id;fe(a);aj=Xi(a);dj(18E5,2);return a}
function cj(a,b){var c=new Zi(b);fe("");aj=Yi(c);0<a&&dj(12E4,a-1);throw c;}
function dj(a,b){R(function(){yd(Ti().then(bj,function(c){return cj(b,c)}),ya)},a)}
function ej(){try{var a=y("yt.ads.biscotti.getId_");return a?a():ee()}catch(b){return wd(b)}}
;function fj(a){if("1"!==gb(ce(),"args","privembed")){a&&de();try{ej().then(function(){},function(){}),R(fj,18E5)}catch(b){je(b)}}}
;var Z=y("ytglobal.prefsUserPrefsPrefs_")||{};x("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function gj(){this.f=P("ALT_PREF_COOKIE_NAME","PREF");var a=Vb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
za(gj);var kj=null,lj=null,mj=null,nj={};function oj(a){var b=a.id;a=a.ve_type;var c=Tg++;a=new Rg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});nj[b]=a;b=Zg();c=Xg();b&&c&&th(b,c,[a])}
function pj(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(bh(b,a),a=Xg()))for(var c in nj){var d=nj[c];d&&th(b,a,[d])}}
function qj(a){nj[a.id]=new Rg({trackingParams:a.tracking_params})}
function rj(a){var b=Zg();a=nj[a.id];if(b&&a){a={csn:b,ve:Sg(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"};var c={ca:ah(b),P:b};"UNDEFINED_CSN"==b?uh("visualElementGestured",a,c):Dg("visualElementGestured",a,Ng,c)}}
function sj(a){a=a.ids;var b=Zg();if(b)for(var c=0;c<a.length;c++){var d=nj[a[c]];if(d){var e=b;d={csn:e,ve:Sg(d),eventType:1};var f={ca:ah(e),P:e};"UNDEFINED_CSN"==e?uh("visualElementShown",d,f):Dg("visualElementShown",d,Ng,f)}}}
...
x("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);fj(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");b="player";var d=void 0===d?!0:d;b="string"===typeof b?ac(b):b;var e=Sh+"_"+Da(b),f=Rh[e];f&&d?a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true")?f.api.loadVideoByPlayerVars(a.args||
null):f.loadNewVideoConfig(a):(f=new Ch(b,e,a,void 0),Rh[e]=f,of("player-added",f.api),Wc(f,Ja(Th,f)));a=f.api;kj=a;a.addEventListener("onScreenChanged",pj);a.addEventListener("onLogClientVeCreated",oj);a.addEventListener("onLogServerVeCreated",qj);a.addEventListener("onLogVeClicked",rj);a.addEventListener("onLogVesShown",sj);d=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?mj=new Ri(a):P("ENABLE_POST_API")&&"string"===typeof d&&"string"===typeof c&&(lj=new Si(window.parent,d,c),mj=new Mi(a,lj.h));
...
var tj=ie(function(){var a=bi(void 0),b;(b=!Q("use_first_tick"))||(b=!("ol"in bi(void 0)));if(b&&(b="ol",X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b)),b=T(),a.ol=b,a=yi(void 0),a.gelTicks&&(a.gelTicks.tick_ol=!0),T(),xi(void 0)?(mi("").tick.ol=T(),a=ei(void 0),qi().tick("ol",a,void 0),fi(),a=!0):a=!1,!a)){if(!y("yt.timing.pingSent_")&&(b=P("TIMING_ACTION",void 0),a=bi(void 0),y("ytglobal.timingready_")&&b&&a._start&&ai())){fi();b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=
0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}if(b&&!xi(void 0)){d=bi(void 0);c=di(void 0);e=d._start;var f=P("CSI_SERVICE_NAME","youtube");b={v:2,s:f,action:P("TIMING_ACTION",void 0)};a=c.srt;void 0!==d.srt&&delete c.srt;if(c.h5jse){var g=window.location.protocol+y("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:void 0)?c.h5jse=Math.round(c.h5jse-g.responseEnd):delete c.h5jse}d.aft=ai();var h=bi(void 0);g=h.pbr;var k=h.vc;h=h.pbs;g&&k&&h&&g<k&&k<h&&di(void 0).yt_pvis&&
"youtube"==f&&(zi("yt_lt","hot_bg",void 0),f=d.vc,g=d.pbs,delete d.aft,c.aft=Math.round(g-f));for(var l in c)"_"!=l.charAt(0)&&(b[l]=c[l]);d.ps=T();l={};f=[];for(var n in d)"_"!=n.charAt(0)&&(g=Math.round(d[n]-e),l[n]=g,f.push(n+"."+g));b.rt=f.join(",");(n=y("ytdebug.logTiming"))&&n(b,l);n=!!c.ap;Q("debug_csi_data")&&(c=y("yt.timing.csiData"),c||(c=[],Ka("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:b}));c="";for(var p in b)b.hasOwnProperty(p)&&(c+="&"+p+"="+b[p]);p="/csi_204?"+
c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&n){var v=void 0===v?"":v;Te(p,v)||Qe(p,void 0,void 0,void 0,v)}else Qe(p);x("yt.timing.pingSent_",!0,void 0);jh(Zh,new Xh(l.aft+(a||0),void 0))}}mi("").tick.ol=T()}v=gj.getInstance();n=!!((jj("f"+(Math.floor(119/31)+1))||0)&67108864);p=1<window.devicePixelRatio;document.body&&ad(document.body,"exp-invert-logo")&&(p&&!ad(document.body,"inverted-hdpi")?(l=document.body,l.classList?l.classList.add("inverted-hdpi"):ad(l,"inverted-hdpi")||
(a=Zc(l),$c(l,a+(0<a.length?" inverted-hdpi":"inverted-hdpi")))):!p&&ad(document.body,"inverted-hdpi")&&bd());n!=p&&(n="f"+(Math.floor(119/31)+1),l=jj(n)||0,l=p?l|67108864:l&-67108865,0==l?delete Z[n]:(p=l.toString(16),Z[n]=p.toString()),v.save())}),uj=ie(function(){var a=kj;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Lf.dispose();a=0;for(var b=Ef.length;a<b;a++){var c=Ef[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}Ef.length=0;yf("//static.doubleclick.net/instream/ad_status.js");Ff=!1;O("DCLKSTAT",0);Yc(mj,lj);if(a=kj)a.removeEventListener("onScreenChanged",pj),a.removeEventListener("onLogClientVeCreated",oj),a.removeEventListener("onLogServerVeCreated",qj),a.removeEventListener("onLogVeClicked",rj),a.removeEventListener("onLogVesShown",
sj),a.destroy();nj={}});
window.addEventListener?(window.addEventListener("load",tj),window.addEventListener("unload",uj)):window.attachEvent&&(window.attachEvent("onload",tj),window.attachEvent("onunload",uj));Ka("yt.abuse.player.botguardInitialized",y("yt.abuse.player.botguardInitialized")||Rf);Ka("yt.abuse.player.invokeBotguard",y("yt.abuse.player.invokeBotguard")||Sf);Ka("yt.abuse.dclkstatus.checkDclkStatus",y("yt.abuse.dclkstatus.checkDclkStatus")||Hf);
